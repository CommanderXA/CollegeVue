...
export default {
    ...
    methods: {
        loadComments () {
            axios
                .get('https://blog-nuxt-41869.firebaseio.com/comments.json')
                    .then((res) => {
                        let commentArray = []
        ...
        changeComment (comment) {
            ...
            axios
                .put(`https://blog-nuxt-41869.firebaseio.com/comments/${comment.id}.json`, comment)
        },
        deleteComment (id) {
            axios
                .delete(`https://blog-nuxt-41869.firebaseio.com/comments/${id}.json`)
